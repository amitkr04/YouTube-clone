    ...
    <div className="px-6 w-[17%] h-[calc(100vh-6.625rem)] overflow-y-scroll overflow-x-hidden ">
      ...
      <div className="mt-4 space-y-3 items-center">
        <div className="flex items-center space-x-2">
          ...
          <FaChevronRight className="font-semibold" />
        </div>
      ...
      <span className="text-xs text-gray-600 font-semibold cursor-pointer">
        ...
        Developers <br />
        <p className="mt-3 cursor-pointer">Terms Privacy Policy & Safety</p> How
        YouTube works <br /> Test new features
      </span>
      <br />
      <p className="text-xs text-gray-500 mt-3">© 2024 Amit Kumar</p>
    </div>
  );
}
